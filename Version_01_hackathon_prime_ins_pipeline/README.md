...
This folder defines all source code for the 'new_prime_ins' pipeline:
...
* Take a look at the sample under "sample_users_new_prime_ins.py" to get familiar with the syntax.
